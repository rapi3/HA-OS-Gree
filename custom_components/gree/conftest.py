...
def mock_setup_entry() -> Generator[AsyncMock, None, None]:
    ...
    with patch(
        "homeassistant.components.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def discovery_fixture():
    ...
    with patch("homeassistant.components.bridge.Discovery") as mock:
...
def device_fixture():
    ...
    with patch(
        "homeassistant.components.bridge.Device",
